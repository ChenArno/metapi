...
describe('dispatchRuntimeRequest', () => {
  ...
  it('uses a plain fetch path for the default runtime executor', async () => {
    ...
    expect(fetchMock.mock.calls[0]?.[0]).toBe('https://probe.example.com/v1/chat/completions');
  });
